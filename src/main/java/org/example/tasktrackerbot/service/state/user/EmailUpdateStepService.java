...
@Service
public class EmailUpdateStepService extends AbstractStateService implements StepHandlerProvider, QueryHandlerProvider {


    public EmailUpdateStepService(BotService botCommandService,
    ...
    public Map<Query, QueryHandler> getQueryHandlers() {
        return Map.of(Query.UPDATE_EMAIL, this::startEmailUpdate);
    }

    @Override
    public Map<UserState, StepHandler> getStepHandlers() {
        return Map.of(UserState.USER_CHANGE_AWAITING_EMAIL, this::handleEmailStep);
    }

    public void startEmailUpdate(String chatId) {
